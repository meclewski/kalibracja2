...
class EquipmentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment_type" do
    assert_difference('EquipmentType.count') do
      post equipment_types_url, params: { equipment_type: { producer_id: @equipment_type.producer_id, type_of_equipment: @equipment_type.type_of_equipment } }
    end
  ...
  test "should update equipment_type" do
    patch equipment_type_url(@equipment_type), params: { equipment_type: { producer_id: @equipment_type.producer_id, type_of_equipment: @equipment_type.type_of_equipment } }
