...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post producers_url, params: { producer: { brand_id: @producer.brand_id, producer_name: @producer.producer_name } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { brand_id: @producer.brand_id, producer_name: @producer.producer_name } }
